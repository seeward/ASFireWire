...
- FireStudio Project has contributor-confirmed GarageBand recording/playback and separate 48 kHz guitar input 1/2 and stereo headphone checks, plus digital clock lock and audible S/PDIF output through a Roland VM-3100 at 44.1 kHz. Short 44.1/48 kHz start/stop and rate-switching checks passed; see the [capture and validation notes](captures/presonus-firestudio-project/README.md) for the exact scope, earlier fault fixes and remaining tests.
