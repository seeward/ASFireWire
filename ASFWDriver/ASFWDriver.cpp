...
kern_return_t ASFWDriver::StartRuntime(IOService* provider) {
    ...
    // The timer is driver-owned because AV/C and SBP-2 both depend on the
    // neutral ITimerScheduler contract. It must exist before either consumer.
